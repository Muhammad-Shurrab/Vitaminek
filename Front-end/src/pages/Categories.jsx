...
function Categories() {
  return (
    <>
        ...
        <div className="products grid grid-cols-3 gap-16 justify-center items-center p-10 pt-7 pr-20">
          <Card className="w-96 card-item group ">
            ...
            <CardBody>
              ...
              >
                Palm oil free whey protein complex with bromelain enzyme, amino
          ...
          <Card className="w-80 card-item group ">
            <CardHeader shadow={false} floated={false} className="h-96">
              <img
                src="https://b3186849.smushcdn.com/3186849/wp-content/uploads/2023/05/chocolate-2-600x600.png?lossy=1&strip=1&webp=1"
                alt="card-image"
      ...
      <div className="btns mt-10 flex items-center justify-center">
        <Pagination />
      </div>
    </>
  );
